...
public class WebRequest {
    ...
    public static void main(String[] args) {
        String url ="https://maps.googleapis.com/maps/api/distancematrix/json?units=metric&origins=Bobcaygeon+ON|24+Sussex+Drive+Ottawa+ON&destinations=New+York+City,NY&key=AIzaSyDvVi80jg583DKu0b0lcyUFWY5rQ_sa6PM";
        WebRequest wr = new WebRequest();
        String response = wr.makeWebServiceCall(url, 0);
